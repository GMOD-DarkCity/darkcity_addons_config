...
TEAM_HITMAN = DarkRP.createJob("Tueur à gage", {
    ...
    weapons = {"arccw_firearms2_scout","arccw_firearms2_pmm","slownls_hitman_tablet","slownls_hitman_binoculars"}, // FIX OLD WEAPONS
    command = "hitman",
    max = 2,
    salary = 0,
    admin = 0,
...
TEAM_TRAINEE= DarkRP.createJob("Deputy Trainee", {
    ...
    description = [[
        NYPD. Patrouille, enquête, protège
    ]],
...
TEAM_SRT = DarkRP.createJob("SRT", {
    ...
    description = [[
        Élite anti-criminalité, tactique et sérieux. Gilet pare-balles, armes lourdes, et un goût prononcé pour l'action musclée.
    ]],
    weapons = {"stunstick","weapon_rpt_finebook","weapon_rpt_handcuff","weapon_rpt_stungun","dradio","emergencyresponse_walkietalkie","door_ram"},    
    command = "ecu",
    max = 8,
...
TEAM_SCU = DarkRP.createJob("SCU", {
    ...
    weapons = {"stunstick","weapon_rpt_finebook","weapon_rpt_handcuff","weapon_rpt_stungun", "emergencyresponse_walkietalkie"},    
    command = "SCU",
    max = 2,
    salary = 50,
    admin = 0,
